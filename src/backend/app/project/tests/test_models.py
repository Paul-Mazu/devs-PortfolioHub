...
class ProjectModelTest(TestCase):
    ...
    def test_project_fields(self):
        ...
        self.assertEqual(
            project.github_link, "Test Github_Link"
        )  # test if it is an actual url and if it has https ending, cant too many tests
        self.assertEqual(
            project.website_link, "Test Website_Link"
        )  # test if it is an actual url and if it has https ending, cant too many tests
...
class CommentModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.comment = Comment.objects.create(
            project=test_project, author=self.user2, body="Test Comment"
        )
